...
# sequence_length = 7  # Set your sequence length
# hidden_size = 512  # Set your hidden size
# classification_model = ViolenceDetectionModel(sequence_length, hidden_size)

# # Load the model weights
# classification_model.load_state_dict(torch.load('notebook/best_violence_detection_model.pth', map_location=torch.device('cpu')))
...
# mode = st.radio("Select Input Mode", ( 'Pre-recorded Video','Real-Time Video'))
...
#             os.system('ffmpeg -i {} -vcodec libx264 {}'.format(output_video_path, 'output_annoted1.mp4'))
...
st.title("Responsive Crime Monitoring and Instant Classification Utilizing AI on Live CCTV Feeds")

col1, col2 = st.columns([1, 1])  # Col1 takes 1/3 of the width, Col2 takes 2/3
